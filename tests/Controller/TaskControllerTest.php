...
class TaskControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'task[name]' => 'Testing',
            'task[todoDate]' => 'Testing',
            'task[createdDate]' => 'Testing',
            'task[updatedDate]' => 'Testing',
            'task[board]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'task[todoDate]' => 'Something New',
            'task[createdDate]' => 'Something New',
            'task[updatedDate]' => 'Something New',
            'task[board]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getTodoDate());
